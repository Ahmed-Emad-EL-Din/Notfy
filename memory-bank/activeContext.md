...
## Recent Changes (Latest Commit: 2d01ee8)
...
- `src/App.tsx`: Priority filter, priority badges, task card updates
- `src/components/TaskEditor.tsx`: Priority dropdown selector
